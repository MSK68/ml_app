"""Приложение создает веб-приложение на основе FastAPI, которое принимает пост запросы с изображением
и возвращает текстовое описание изображения. Для распознавания изображения используется модель,
использованная для выполнения задания 2 в папке svasilev/task02/main.py"""
...
if __name__ == "__main__":
    uvicorn.run(app, host="https://krapiva.space", port=8000)

# Запускаем сервер с помощью команды uvicorn main:app --reload
# Переходим по адресу http://krapiva.space:8000/docs
